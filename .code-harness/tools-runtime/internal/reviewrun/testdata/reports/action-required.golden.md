...
|---|---|---|---|---|
| F-002 | 中 | 异常路径缺少重试边界 | 瞬时失败可能直接返回 | 明确重试或失败语义 |
...
- `src/main/java/com/example/OrderServiceImpl.java`，第 12 行
