...
func Certify(ctx CertifyContext, proposals []Proposal) (CertifiedSet, Certificate, []Rejection, error) {
	...
	set := CertifiedSet{
		RunID:                  ctx.RunID,
		HarnessVersion:         strings.TrimSpace(ctx.HarnessVersion),
		ChangeSetSHA256:        ctx.ChangeSetSHA256,
		ChangeAnalysisSHA256:   ctx.ChangeAnalysisSHA256,
		ReviewUnitsSHA256:      ctx.ReviewUnitsSHA256,
		RuleDispatchSHA256:     ctx.RuleDispatchSHA256,
		FindingProposalsSHA256: ctx.FindingProposalsSHA256,
	...
	cert := Certificate{
		RunID:                   ctx.RunID,
		CertifiedFindingsSHA256: hashFindingBytes160(setBytes),
		ChangeSetSHA256:         ctx.ChangeSetSHA256,
		ChangeAnalysisSHA256:    ctx.ChangeAnalysisSHA256,
		ReviewUnitsSHA256:       ctx.ReviewUnitsSHA256,
		RuleDispatchSHA256:      ctx.RuleDispatchSHA256,
		FindingProposalsSHA256:  ctx.FindingProposalsSHA256,
		Mode:                    mode,
		ScopeSHA256:             strings.TrimSpace(ctx.ScopeSHA256),
	}
...
func hashFindingBytes160(data []byte) string {
